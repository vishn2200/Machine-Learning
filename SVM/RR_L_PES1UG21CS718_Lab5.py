...
class SVM:
    ...
    def build_models(self):
        ...
        model1 = Pipeline([('scaler', StandardScaler()), ('svr', SVR(kernel='linear', degree=3, gamma='auto', coef0=0.0, tol=0.001, C=1.0, epsilon=0.1, 
                     shrinking=True, cache_size=200, verbose=False, max_iter=-1))])
        
        

        model2 = Pipeline([('scaler', StandardScaler()), ('svc', SVC(C=8, kernel='rbf', degree=3, gamma='scale', coef0=0.0, shrinking=True, 
                     probability=False, tol=0.001, cache_size=200, class_weight=None, verbose=False,
                       max_iter=-1, decision_function_shape='ovr', break_ties=False, random_state=None))])
        
        
        model3 = Pipeline([('scaler', StandardScaler()), ('svc', SVC(C=30, kernel='rbf', gamma=4, coef0=0.0, shrinking=True, probability=True, tol=0.001, 
                    cache_size=1000, class_weight=None, verbose=False, max_iter=-1, decision_function_shape='ovr', break_ties=False, random_state=42))])
